...
contract ERC20 is Context, IERC20 {
    ...
    string private _name = "DISCOVERSECITY";
    string private _symbol = "DISCO";
...
contract Discoversecity is ERC20, Ownable {
    ...
    function withdrawLockedEth(address payable recipient, uint256 amount)
        external
        onlyOwner
    {
        require(
        ...
        require(
            amount > 0,
            "The ETH amount must be greater than 0"
        );
        require(
    ...
    constructor() {
        ...
        discosup = 500000 * 10**6 * 10**18;

        _mint(treasuryWalletAddr, discosup);
    }
    ...
    function transferDiscoByOwner(address _to, uint256 _amount)
        external
        onlyOwner
    {
